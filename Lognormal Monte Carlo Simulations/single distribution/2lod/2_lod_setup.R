...
## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
generate_ln_IIlod <- function(sample_size, GM, GSD, 
...
q <- generate_ln_IIlod(15, 1, 2, .1, .15)
q


## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
one_run_ln_IILOD <- function(sample_size, GM, GSD, 
                            fraction_censored1, fraction_censored2,
                            distro = "lognormal", ..., .max_tries = 30){
  
  #generate dataset
  dataset_object <- generate_ln_IIlod(sample_size, GM, GSD, fraction_censored1, fraction_censored2)
...
dee <- one_run_ln_IILOD(15, 1, 2, .1, .2) 
dee
