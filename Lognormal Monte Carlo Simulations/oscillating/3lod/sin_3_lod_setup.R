...
## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
generate_sin_IIIlod <- function(sample_size, GM, 
...
q <- generate_sin_IIIlod(30, 1, 2, .1, .15, .2)
q



## --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
one_run_sin_IIILOD <- function(sample_size, GM, 
                              GSD, fraction_censored_1, 
                              fraction_censored_2, fraction_censored_3, 
                              distro = "lognormal", ..., .max_tries = 30){
  
  #generate dataset
  dataset_object <- generate_sin_IIIlod(sample_size, GM, 
                                       GSD, fraction_censored_1, 
                                       fraction_censored_2, fraction_censored_3)
...
one_run_sin_IIILOD(15, 1, 2, .1, .2, .3) 
