...
## ----------------------------------------------------------------------------------------------------------------------------------------
generate_sin_Ilod <- function(sample_size, GM, GSD, fraction_censored_1){
...
q <- generate_sin_Ilod(15, 1, 2, .1)
q

# qbig <- generate_sin_Ilod(30, 1, 2, .1)
...
one_run_sin_ILOD <- function(sample_size, GM, GSD, fraction_censored, distro = "lognormal", ..., .max_tries = 30){
  
  #generate dataset
  dataset_object <- generate_sin_Ilod(sample_size, GM, GSD, fraction_censored)
